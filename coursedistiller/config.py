...
DEFAULTS = {
    ...
    "video": {"enabled": True, "whisper_model": "mlx-community/whisper-large-v3-turbo",
              "priority": [], "max_videos": 0},
    "distill": {"enabled": True, "ollama_url": "http://localhost:11434", "model": "gpt-oss:20b",
                "reasoning": "low", "max_tokens": 2000, "chunk_chars": 9000},
